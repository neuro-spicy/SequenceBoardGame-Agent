...
def make_agent_with_weights(
    ...
    """
    create a CombinedAgent that uses specific heuristic weights.

    temporarily swaps DEFAULT_WEIGHTS in the heuristic module.
    the agent captures the weights at creation time via a closure.
    """
...
def train_weights(
    ...
    for gen in range(n_generations):
        ...
        for v in range(n_variants):
            ...
            # play the variant against the current best
